...
import BulletIcon from "../../../public/assets/CaseStudy/Icon.svg";
    ...
    <>
      <div className="">
        <TopBannerCard
          ...
          breadcrumb={["Home", "Case Studies", data.topBanner.title]}
        />
            ...
            <div className="flex flex-col md:flex-row gap-7">
              ...
              <div className="w-full md:w-[25%] flex flex-col gap-7 sticky-column">
                ...
                <div className="bg-[#0b1629] rounded-3xl shadow-md py-7 px-7 flex flex-col items-center gap-4">
                  ...
                  <div className="w-full bg-[#001060] h-32 flex items-center justify-center rounded-3xl">
                    <Image
                ...
                {/* Card 2 */}
                <div
                  className="relative h-96 rounded-3xl overflow-hidden bg-cover bg-center text-white flex items-center justify-center"
                  style={{
                ...
                >
                  <div className="max-w-[80%] lg:mt-30">
                    <div>
                      ...
                      <p className="text-md mt-5">{data.cards.strategy.description}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Right Column */}
              <div className="w-full md:w-[75%] rounded p-0">
                <h2
