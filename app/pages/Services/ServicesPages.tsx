...
import right from "@/public/assets/Icons/wRightArrow.svg"
      ...
      <div className="">
        <div>
          <TopBannerCard
            ...
            breadcrumb={["Home", "Services", data.banner.heading]}
          />
        </div>
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="w-full md:w-[75%] rounded md:p-6">
                ...
                <div className="flex flex-row gap-8 mt-5">
                  <div className="w-full">
                    <ul className="space-y-0">
                      {data.mainSection.advantage.bulletPoints.map(
                        (point, idx) => (
                          <li key={idx} className="flex items-start gap-3">
                            <Image
                              src={Icon}
                ...
                <div className="bg-black rounded-xl text-white p-5 pt-10 mt-10">
                  <div className="grid grid-cols-1 md:grid-cols-[70%_30%] gap-4">
                    ...
                    {data.mainSection.projects.buttons.map((button, index) => (
                      ...
                      <div className="flex gap-4">
                        {data.mainSection.projects.buttons.map(
                          (button, index) => {
                            ...
                            const ButtonContent = (
                              <button
                                ...
                                onClick={
                                  !button.link ? handleCopyLink : undefined
                                }
                              >
                                {button.icon && (
                                  <Image
                ...
                <div className="relative bg-[#F0F2F4] py-10 px-7 md:py-15 md:px-10 rounded-3xl overflow-hidden mt-10">
                  <h2
                  ...
                  <Image
                    ...
                    alt="Decor"
                    className="absolute bottom-0 left-0 max-w-3xs w-full h-auto pointer-events-none object-cover opacity-40"
                  />
                </div>
              </div>
            </div>
